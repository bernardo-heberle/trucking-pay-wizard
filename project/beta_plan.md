...
- **Confidence review UI** — the LLM extractor produces per-field confidence scores, but surfacing low-confidence fields in the GUI for staff review is future work
